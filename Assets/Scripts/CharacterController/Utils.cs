...
namespace CharacterController
{
    ...
    public static class Util
    {
        ...
        /// </summary>
        /// <param name="stepInput"></param>
        /// <param name="characterMass"></param>
        /// <param name="affectBodies"></param>
        /// <param name="collider"></param>
        /// <param name="transform"></param>
        /// <param name="linearVelocity"></param>
        /// <param name="deferredImpulseWriter"></param>
        /// <param name="collisionEvents"></param>
        ...
        /// <summary>
        /// 创建SurfaceConstraintInfo组件？
        /// CreateConstraint包含的第一个方法
        /// </summary>
        /// <param name="world"></param>
        /// <param name="rigidBodyIndex"></param>
        /// <param name="colliderKey"></param>
        ...
        /// <summary>
        ///  CreateConstraint包含的第二个方法
        /// </summary>
        /// <param name="up"></param>
        /// <param name="constraint"></param>
        /// <param name="maxSlopeConstraint"></param>
